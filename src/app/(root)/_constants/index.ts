...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    ...
    defaultCode: `// JavaScriptda Namuna
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    ...
    defaultCode: `// TypeScriptda Namuna
...
class Program {
  ...
  ruby: {
    ...
    monacoLanguage: "ruby",
    defaultCode: `# Create array Namuna
numbers = [1, 2, 3, 4, 5]
